...
const categories = [
  {
    ...
    description:
      'Learn how to use Whitelabel effectively and make the most of its features to enhance customer support and engagement.',
    articlesCount: '2',
    articles: [
      {
  ...
  },
  {
    ...
    title: 'Marketing',
    description:
      'Learn how to use Whitelabel effectively and make the most of its features to enhance customer support.',
    articlesCount: '4',
    articles: [
      {
        variant: 'Draft article',
