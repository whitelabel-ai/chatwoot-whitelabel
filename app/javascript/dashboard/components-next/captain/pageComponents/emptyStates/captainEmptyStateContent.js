...
export const documentsList = [
  {
    ...
    external_link:
      'https://www.whitelabel.lat/hc/user-guide/articles/1677688192-how-to-use-conversation-filters',
    id: 3059,
    name: 'How to use Conversation Filters? | User Guide | Whitelabel',
    status: 'available',
  },
  {
    account_id: 2,
    ...
    content:
      'Step-by-step guide for automating ticket assignments and improving support workflow in Whitelabel.',
    created_at: 1736143273,
    external_link:
      'https://www.whitelabel.lat/hc/user-guide/articles/1677688200-automating-ticket-assignments',
    id: 3060,
    name: 'Automating Ticket Assignments | User Guide | Whitelabel',
    status: 'available',
  },
  {
    account_id: 3,
    ...
    external_link:
      'https://www.whitelabel.lat/hc/user-guide/articles/1677688210-managing-customer-profiles',
    id: 3061,
    name: 'Managing Customer Profiles | User Guide | Whitelabel',
    status: 'available',
  },
  {
    account_id: 4,
    ...
    external_link:
      'https://www.whitelabel.lat/hc/user-guide/articles/1677688220-sales-tracking-guide',
    id: 3062,
    name: 'Sales Tracking Guide | User Guide | Whitelabel',
    status: 'available',
  },
  {
    account_id: 5,
    ...
    content:
      'How to efficiently create, manage, and resolve tickets in Whitelabel.',
    created_at: 1736143276,
    external_link:
      'https://www.whitelabel.lat/hc/user-guide/articles/1677688230-managing-tickets',
    id: 3063,
    name: 'Managing Tickets | User Guide | Whitelabel',
    status: 'available',
  },
  {
    account_id: 6,
    ...
    external_link:
      'https://www.whitelabel.lat/hc/user-guide/articles/1677688240-financial-reporting',
    id: 3064,
    name: 'Financial Reporting | User Guide | Whitelabel',
    status: 'available',
  },
];
...
export const responsesList = [
  {
    ...
    id: 87,
    question: 'Why is my Messenger in Whitelabel deactivated?',
    status: 'pending',
    assistant: {
      account_id: 1,
      config: { product_name: 'Whitelabel' },
  ...
  },
  {
    ...
    id: 88,
    question: 'How do I integrate WhatsApp with Whitelabel?',
    assistant: {
      account_id: 2,
      config: { product_name: 'Whitelabel' },
  ...
  },
  {
    ...
    id: 89,
    question: 'How can I reset my password in Whitelabel?',
    assistant: {
      account_id: 3,
      config: { product_name: 'Whitelabel' },
  ...
  },
  {
    ...
    id: 90,
    question: 'How do I enable dark mode in Whitelabel?',
    assistant: {
      account_id: 4,
      config: { product_name: 'Whitelabel' },
  ...
  },
  {
    ...
    id: 91,
    question: 'How do I add a new team member in Whitelabel?',
    assistant: {
      account_id: 5,
      config: { product_name: 'Whitelabel' },
  ...
  },
  {
    account_id: 6,
    answer:
      "Campaigns in Whitelabel allow you to send targeted messages to specific user segments. You can create them in the 'Campaigns' section.",
    created_at: 1736283380,
    id: 92,
    question: 'What are campaigns in Whitelabel?',
    assistant: {
      account_id: 6,
      config: { product_name: 'Whitelabel' },
